...
function init() {
    try {
        ...
        const qResponses = await getData();
        const genData = generateMarkdown(qResponses);

        //write the readme in a new file to not mess up existing read me file
        await writeFile("./output/README.md", genData);
